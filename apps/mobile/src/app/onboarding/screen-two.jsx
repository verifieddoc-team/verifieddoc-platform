...
export default function OnboardingScreenTwo() {
  ...
  const handleNext = () => {
    router.push("/onboarding/screen-three");
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.textBlock}>
          <Text style={styles.heading}>Share Securely</Text>
          <Text style={styles.description}>
            Share your credentials instantly with employers and
            organizations while keeping full control.
          </Text>
        </View>
